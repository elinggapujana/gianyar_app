				...
				<div class="col-sm-6">
					...
					<form method="post">
						<div class="form-group">
							...
							<input type="text" name="id" id="id" class="form-control" value="<?php echo $row[0]['id']; ?>" placeholder="Enter ID" required>
						</div>
						<div class="form-group">
							<label>Alamat <span class="text-danger">*</span></label>
							<input type="text" name="alamat" id="id" class="form-control" value="<?php echo $row[0]['alamat']; ?>" placeholder="Enter Alamat" required>
						</div>
						<div class="form-group">
							<label>Desa ID<span class="text-danger">*</span></label>
							<input type="text" name="desa_id" id="desa_id" class="form-control" value="<?php echo $row[0]['desa_id']; ?>" placeholder="Enter Desa" required>
						</div>
							<div class="form-group">
							<label>Kecamatan ID <span class="text-danger">*</span></label>
							<input type="text" name="kecamatan_id" id="kecamatan_id" class="form-control" value="<?php echo $row[0]['kecamatan_id']; ?>" placeholder="Enter Kecamatan" required>
						</div>
						</div>
							<div class="form-group">
							<label>Nama Penerima <span class="text-danger">*</span></label>
							<input type="text" name="nama_penerima" id="nama_penerima" class="form-control" value="<?php echo $row[0]['nama_penerima']; ?>" placeholder="Nama Penerima" required>
						</div>

							<div class="form-group">
							<label>Nomor KTP <span class="text-danger">*</span></label>
							<input type="text" name="nomor_ktp" id="nomor_ktp" class="form-control" value="<?php echo $row[0]['nomor_ktp']; ?>" placeholder="Nomor KTP" required>
						</div>

							<div class="form-group">
							<label>Nomor KK <span class="text-danger">*</span></label>
							<input type="text" name="nomor_kk" id="nomor_kk" class="form-control" value="<?php echo $row[0]['nomor_kk']; ?>" placeholder="Nomor KK" required>
						</div>

							<div class="form-group">
							<label>Jenis Bantuan ID <span class="text-danger">*</span></label>
							<input type="text" name="jenis_bantuan_id" id="jenis_bantuan_id" class="form-control" value="<?php echo $row[0]['jenis_bantuan_id']; ?>" placeholder="Jenis Bantuan ID" required>
						</div>

							<div class="form-group">
							<label>Lintang <span class="text-danger">*</span></label>
							<input type="text" name="lintang" id="lintang" class="form-control" value="<?php echo $row[0]['lintang']; ?>" placeholder="Lintang" required>
						</div>

							<div class="form-group">
							<label>Bujur <span class="text-danger">*</span></label>
							<input type="text" name="bujur" id="bujur" class="form-control" value="<?php echo $row[0]['bujur']; ?>" placeholder="Bujur" required>
						</div>

						<div class="form-group">
							<label>Keterangan <span class="text-danger">*</span></label>
							<input type="text" name="keterangan" id="keterangan" class="form-control" value="<?php echo $row[0]['keterangan']; ?>" placeholder="Keterangan" required>
						</div>
						<div class="form-group">
