				...
				<div class="col-sm-6">
					...
					<form method="post">
						...
						<div class="form-group">
							...
							<input type="text" name="desa_id" id="desa_id" class="form-control" placeholder="Enter Desa ID" required>
						...
						<div class="form-group">
							...
							<input type="text" name="nama_penerima" id="nama_penerima" class="form-control" placeholder="Nama Penerima" required>
						...
						<div class="form-group">
							...
							<input type="text" name="nomor_ktp" id="nomor_ktp" class="form-control" placeholder="Nomor KTP" required>
						...
						<div class="form-group">
							...
							<input type="text" name="nomor_kk" id="nomor_kk" class="form-control" placeholder="Nomor KK" required>

						</div>

						<div class="jenis_bantuan_id">

							<label>User Name <span class="text-danger">*</span></label>

							<input type="text" name="jenis_bantuan_id" id="jenis_bantuan_id" class="form-control" placeholder="jenis_bantuan_id" required>
						...
						<div class="form-group">
							...
							<input type="text" name="lintang" id="lintang" class="form-control" placeholder="lintang" required>
						...
						<div class="form-group">
							...
							<input type="text" name="bujur" id="bujur" class="form-control" placeholder="bujur" required>
